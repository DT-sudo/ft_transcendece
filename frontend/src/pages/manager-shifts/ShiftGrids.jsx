...
const chipTitle = (shift) => `${shift.position} ${shift.start_time}-${shift.end_time}`;
...
function WeekShiftChip({ shift, style, onSelect }) {
...
export function WeekGrid({ startISO, todayISO, shifts, onSelectShift, onCreateSlot }) {
